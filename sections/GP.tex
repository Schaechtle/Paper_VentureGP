...
#\includegraphics[width=5cm]{figs/interactive_gp_prior.png}#
(sample (g '(1 2 3)))
;; [-1.04331626 -0.72016875 -0.44525212]
(call_back draw_gp_curves g ...)
#\includegraphics[width=5cm]{figs/interactive_gp_after_sample.png}#
(predict (g '(1 2 3)))
;; [ 0.55736593  0.09784888  0.56553757]
(call_back draw_gp_curves g ...)
#\includegraphics[width=5cm]{figs/interactive_gp_after_predict.png}#
\end{lstlisting}
\end{mdframed}

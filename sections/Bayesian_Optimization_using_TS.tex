...
\myparagraph{Framework}\label{sec:thompson-framework}
...
function at points near $a$ (see Figure \ref{fig:slide2}).\footnote{
 ...
 We see a comlete probabilistic program with \gpmem\ implementing Bayesian optimization with Thompson Sampling below (Listing \ref{alg:bayesopt)}).

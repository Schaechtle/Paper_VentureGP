...
\put(-119,132){\scriptsize Drift Proposal}
\put(-119,120){\scriptsize Uniform Proposal}
\put(-119,108){\scriptsize Global Optimum}
\put(-119,96){\scriptsize Local Optima}
...
\end{tabular}
\put(-360,122){\footnotesize$i = 2$}
\put(-238,122){\footnotesize$i = 3$}
\put(-117,122){\footnotesize$i = 4$}
\put(-360,56){\footnotesize$i = 5$}
\put(-238,56){\footnotesize$i = 6$}
\put(-117,56){\footnotesize$i = 7$}
\put(-360,-8){\footnotesize$i = 8$}
\put(-238,-8){\footnotesize$i = 9$}
\put(-117,-8){\footnotesize$i = 10$}
\put(-360,-72){\footnotesize$i = 11$}
\put(-238,-72){\footnotesize$i = 12$}
\put(-117,-72){\footnotesize$i = 13$}

...
thus treat the notations $a,r,\abf,\rbf$ as synonyms for
$x,f,\xbf,\fbf$, respectively, differing only in that they carry the
...
\begin{figure}[p]
  ...
  \caption{
    ...
    table and the parameters $\thetabf$ are updated according to this new
    information.

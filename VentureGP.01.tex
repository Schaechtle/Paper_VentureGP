...
When $P(\theta)$ has high entropy and is concentrated on a region of belief space that closely matches the true distributions $P_\true(r|a)$, exploration will be less likely to occur, but the chosen actions $a$ will tend to receive high rewards.

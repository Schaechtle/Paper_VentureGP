...
% Venture terminology
\chardef\_=`\_ % http://tex.stackexchange.com/questions/4375/chardef-and-underscore
\newcommand{\se}{\ttfamily{gp\_cov\_scale(sf, gp\_cov\_se(l))}}
\newcommand{\wn}{\ttfamily{gp\_cov\_scale(sigma, gp\_cov\_delta())}}

...
\node[below = 0.7cm of data] (post_param) {\includegraphics[width=0.7\textwidth]{figs/mauna_sample_1.png}};
\node[below = 0.7cm of post_param] (posterior) {\includegraphics[width=0.7\textwidth]{figs/mauna_structure.png}};
...
\node[draw,color=red,dashed, rectangle, left = -1.755cm of posterior,minimum width = 0.45cm, minimum height = 5.8cm,yshift=0.2cm] (mark_structure) {};

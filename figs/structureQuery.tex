...
% level 3
\node[below =.5cm of trend_png , xshift=-2.5cm] (linear_trend) {\color{blue} A linear trend?};
...
\node[below =.5cm of noise_png, xshift=2.5cm] (white_noise) {\color{blue} White  noise? };
...
% level 5
\node[below =.5cm of recurring_png] (seper_form) {$P(\text{PER}\times\text{SE})=0.34$};
\node[below = -0.2cm of seper_form] (seper_png) {\includegraphics[width=.15\textwidth]{figs/gpSamples/seper.png}};

\node[below =.5cm of recurring_png, xshift=-4.0cm] (per_form) {$P(\text{PER})=0.32$};
\node[below = -0.2cm of per_form] (per_png) {\includegraphics[width=.15\textwidth]{figs/gpSamples/per.png}};

\node[below =.5cm of recurring_png,xshift=4.0cm] (perlin_form)
{$P(\text{PER}\times\text{LIN})=0.07$};

...
\begin{tikzpicture}
\node[] (data) {\includegraphics[width=0.7\textwidth]{figs/airline_data.png}};
\node[below= 0.7cm of data] (post_param) {\includegraphics[width=0.7\textwidth]{figs/airline_sample_28.png}};


\node[below = 0.7cm of post_param] (posterior) {\includegraphics[width=0.7\textwidth]{figs/airline_structure.png}};
...
\node[draw, rectangle, left = -1.83cm of posterior,minimum width = 0.45cm, minimum height = 5.8cm,yshift=0.2cm] (mark_structure) {};

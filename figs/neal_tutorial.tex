...
\end{lstlisting}
 &
\raisebox{-0.5\height}{\includegraphics[height=3.4cm]{figs/neal_example_before_observation.jpg}}  \\ \hline
% line 3
...
\end{lstlisting}
 &
\raisebox{-0.5\height}{\includegraphics[height=3.4cm]{figs/neal_example_after_observation.jpg}}  \\ \hline
\footnotesize\begin{lstlisting}[mathescape,escapechar=\#]
// Metropolis-Hastings
infer repeat(100, do(
    mh(scope="hyperhyper", steps=2),
    mh(scope="hyper",      steps=1)));#\vspace{1mm}#
sample f_emu(array(-2, $\cdots$, 2));
\end{lstlisting}
 &   \raisebox{-0.5\height}{\includegraphics[height=3.4cm]{figs/neal_Bayesian.jpg}} \\ \hline
\footnotesize\begin{lstlisting}[mathescape,escapechar=\#]
// Optimization
...
\end{lstlisting}
 &
\raisebox{-0.5\height}{\includegraphics[height=3.4cm]{figs/neal_example_map_inference_alpha0p01_iter15.jpg}} \\ \hline
